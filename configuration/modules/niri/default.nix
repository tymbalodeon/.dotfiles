    ...
    xdg.configFile."niri/config.kdl" = {
      ...
      text = let
        binds =
          ...
          + (
            if config.laptop
            then ''                  Shift+XF86MonBrightnessDown { spawn-sh "brightnessctl --device tpacpi::kbd_backlight set 1%-"; }
            ...
            else ''                  XF86MonBrightnessDown allow-when-locked=true cooldown-ms=500 { spawn-sh "nu ${../monitors/brightness.nu} decrease";}

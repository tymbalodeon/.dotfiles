  ...
  in {
    ...
    wayland.windowManager.hyprland = {
      ...
      settings = {
        ...
        bindel =
          [
            ", XF86AudioLowerVolume, exec, nu ${./hyprland-is-muted.nu} && wpctl set-volume @DEFAULT_AUDIO_SINK@ 1%-"
            ", XF86AudioNext, exec, rmpc next"
            ", XF86AudioPlay, exec, playerctl play-pause; rmpc togglepause"
            ", XF86AudioPrev, exec, rmpc prev"
            ", XF86AudioRaiseVolume, exec, nu ${./hyprland-is-muted.nu} && wpctl set-volume --limit 1.0 @DEFAULT_AUDIO_SINK@ 1%+"
          ]

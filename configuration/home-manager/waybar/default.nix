    ...
    programs.waybar = {
      ...
      settings.bar = {
        ...
        "custom/wallpaper" = {
          ...
          exec = "nu ${../wallpaper/wallpaper-status.nu}";
          format = " {}";
          hide-empty-text = true;
          interval = 60;
          on-click-middle = "nu ${../wallpaper/wallpaper.nu} toggle-pause";
          on-click = "nu ${../wallpaper/wallpaper.nu} next";
          on-click-right = "nu ${../wallpaper/wallpaper.nu} previous";
          return-type = "json";
          signal = 2;
        };
